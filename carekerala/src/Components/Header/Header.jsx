...
function Header() {
  ...
  const handleLogout = () =>{
    try{
      ...
      axios.post(`${baseURL}/hospitals/dashboard/logout`)
      .then(() => {
        ...
        <nav>
          {user?.role === "hospital" ?(
            <ul className={styles.fnavList}>
              ...
              <li>
                <button onClick={handleLogout} className={styles.btnRed}>Log Out</button>
              </li>
            </ul>
          ) : (
            <>
        ...
        >
          ...
          {user?.role === "hospital" ?(
            ...
            <>
              <ul className={styles.snavList}>
                <li>
                  <Link to={"/"} className={styles.link} onClick={closeSideNavBar}>
                    Home
                  </Link>
                ...
                <li>
                  <Link to={"/hospitals"} className={styles.link} onClick={closeSideNavBar}>
                    Hospitals
                  </Link>
                </li>

                <li>
                  <Link to={"/doctors"} className={styles.link} onClick={closeSideNavBar}>
                    Doctors
                  </Link>
                </li>
                ...
                {userAuth ? (
                  <>
                    <li>
                      <Link to={"/h-sheet/" + user.id} className={styles.link} onClick={closeSideNavBar}>
                        H-Sheet
                      </Link>
                    </li>
                    {user?.role === 'doctor' ? (
                  ...
                  <li>
                    <Link to={"/users/login"} className={styles.link} onClick={closeSideNavBar}>
                      Register / Login
                    </Link>
                  </li>
                )}
